    ...
    <div>
      ...
      <div className="mt-16 lg:mt-24">
        <section className="py-10 bg-white sm:py-16 lg:py-24">
          <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8 space-y-5">
            <h1 className="font-black tracking-wider uppercase">
              Terms and Conditions
            </h1>
            <p className="italic font-base">Last updated: January 01, 2023</p>
            <p>
            ...
            <h1 className="font-black tracking-wider uppercase">
             ...
             <h2 className="font-bold tracking-wide">Interpretation</h2>
            <p>
             ...
             <h2 className="font-bold tracking-wide">Definitions</h2>
            ...
            <ul className="space-y-5">
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Crypto Trading
                  Hub LLC, Tower, 1101 Brickell Ave, Miami, Fl, 33131. United
                  States..
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Crypto Trading Hub,
                  accessible from{" "}
                  <a
                    href="https://crypto-tradinghub.org"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://crypto-tradinghub.org
                  </a>
                </p>
              </li>
              <li>
            ...
            <h1 className="font-black tracking-wider uppercase">Termination</h1>
            <p>
            ...
            <h1 className="font-black tracking-wider uppercase">
             ...
             <h2 className="font-bold tracking-wide">Severability</h2>
            <p>
             ...
             <h2 className="font-bold tracking-wide">Waiver</h2>
            <p>
            ...
            <h1 className="font-black tracking-wider uppercase">Contact Us</h1>
            <p>
              If you have any questions about these Terms and Conditions, You
              can contact us:
            </p>
            <ul className="space-y-5">
              <li>By email: surpport@crypto-tradinghub.com</li>
            </ul>
          </div>
        </section>
      </div>
