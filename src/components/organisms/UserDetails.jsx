        ...
        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 col-span-1">
          ...
          <div class="flex flex-col pt-3">
            <dt class="mb-1 text-gray-500 md:text-lg">Password</dt>
                      <dd class="text-lg font-semibold">{show ? data.password : '***********'} <span onClick={SetShow} className="cursor-pointer text-sm text-blue-900 hover:underline mx-2 pb-3">{show ? 'hide' : 'show'}</span></dd>
          </div>
        </dl>
        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 col-span-1">
          <div class="flex flex-col pt-3">
